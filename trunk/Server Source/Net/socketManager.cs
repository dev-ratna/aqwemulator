...
namespace AQWE.Net
{
    ...
    class socketManager
    {
        ...
        /// </summary>
        private static Dictionary<int, connectionManager> Connections;
        /// <summary>
        ...
        public static bool Listen(int Port, int MaxConnections, int backLog)
        {
            try
            {
                ...
                Connections = new Dictionary<int, connectionManager>();
        ...
        private static void createConnection(Socket newClient)
        {
            ...
            {
                connectionCounter++;
                connectionManager Connection = new connectionManager(connectionCounter, newClient);
        ...
        public static void endConnection(connectionManager Connection)
        {
