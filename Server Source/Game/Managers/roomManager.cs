...
namespace AQWE.Game.Managers
{
    public static class roomManager
    {
        ...
        public static void UserJoined(userManager _user, int _roomID)
        {
            ...
            sendToRoom(_roomID, "<msg t='sys'><body action='uER' r='" + _room.ID + "'><u i='" + _userInfo.userID + "' m='" + _user.isModerator + "' s='0' p='" + _userInfo.playerID + "'><n><![CDATA[" + _userInfo.Username + "]]></n><vars></vars></u></body></msg>");
        ...
        {
            sendToRoom(_roomID, "<msg t='sys'><body action='userGone' r='" + _roomID + "'><user id='" + _user.Session.userInfo.userID + "' /></body></msg>");
            sendToRoom(_roomID, "%xt%exitArea%-1%" + _user.Session.userInfo.userID + "%");
        }

        public static string getPlayers(int _roomID)
        {
            string ret = "<uLs r='" + _roomID + "'>";
        ...
        public static string getMoveToArea(int _roomID)
        {
            ...
            ret += "\"strMapFileName\":\"" + _room.fileName + "\",\"intType\":\"2\",\"monBranch\":[],\"wB\":[],\"sExtra\":\"a1=test1,a2=test2\",\"areaId\":" + _roomID + ",\"strMapName\":\"" + _room.mapName + "\"}}}";
